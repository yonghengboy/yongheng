...
public class BooksTest {
    ...
    static void objecToFile() {
        //1.创建对象输出流
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/homework/cThree/books/books.txt"))) {
    ...
    static void fileToobject() {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/homework/cThree/books/books.txt"))) {
